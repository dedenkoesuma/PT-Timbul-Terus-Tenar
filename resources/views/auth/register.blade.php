                ...
                <img class="img-fluid " src="images/logo.png" width="150px" alt="Sample image"  style="margin-left:120px;margin-top: 20px; margin-bottom:20px;">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus class="form-control form-control-lg" >
                        </div>
                        <!-- Email input -->
                        <div class="form-outline mb-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <a  href="{{ route('login') }}" class="text-body">Already registered?</a>
                        </div>
                        <!-- btn login -->
